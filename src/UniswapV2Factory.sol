...
// import {IUniswapV2} from "./interfaces/IUniswapV2Pair.sol"; //not yet created
...
contract UniswapV2Factory {
    ...
    function createPair(address tokenA, address tokenB) public returns (address pair){
        ...
        bytes salt = keccak256(abi.encodePacked(token0, token1)); //sequence of bytes thats used to generate new contract's address deterministically
        assembly {
